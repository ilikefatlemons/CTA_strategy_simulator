...
test_data/raw_1m/{sym}.parquet, 之后就不再读大文件了。
"""
import os
import sys
...
def check_day(sym: str = "AU", date: str = "2025-10-09", compare_raw: bool = True) -> None:
    ...
    out = os.path.join(ROOT, "test_data", f"check_{sym}_{day.date()}.csv")
